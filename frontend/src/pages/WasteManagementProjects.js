         ...
         <div className="bg-gradient-to-b from-[#E1F3F5] to-[#C5E8ED] min-h-screen">
            <div className="container max-w-4xl mx-auto px-4 py-12 font-poppins">
               <h1 className="text-4xl md:text-5xl font-bold mb-8 text-center">
                  <span className="text-[#093620]">Waste Management Projects</span>
               </h1>
               <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                  <p className="text-lg text-gray-700 mb-6">
                     Our clients in waste management qualify for carbon credits in both composting and recycling projects. We are currently in the process of validating their credits.
                  </p>
                  <div className="bg-[#E1F3F5] border-l-4 border-[#2B6E2B] p-4 rounded">
                     <p className="text-[#093620] font-medium">
                        Come back soon to know more!
                     </p>
                  </div>
               </div>
...
export default WasteManagementProjects;